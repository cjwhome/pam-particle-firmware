...
nanoMY_pb_version = "nanopb-0.4.6-dev"
...
try:
    ...
    import proto.nanoMY_pb_pb2 as nanoMY_pb_pb2 # pyinstaller seems to need this
...
try:
    from .proto import nanoMY_pb_pb2
    ...
    import proto.nanoMY_pb_pb2 as nanoMY_pb_pb2
    from proto._utils import invoke_protoc
except:
    sys.stderr.write('''
         ********************************************************************
...
datatypes = {
    ...
    (FieldD.TYPE_INT32,   nanoMY_pb_pb2.IS_8):   ('int8_t',   'INT32', 10,  1),
    (FieldD.TYPE_INT32,  nanoMY_pb_pb2.IS_16):   ('int16_t',  'INT32', 10,  2),
    (FieldD.TYPE_INT32,  nanoMY_pb_pb2.IS_32):   ('int32_t',  'INT32', 10,  4),
    (FieldD.TYPE_INT32,  nanoMY_pb_pb2.IS_64):   ('int64_t',  'INT32', 10,  8),
    (FieldD.TYPE_SINT32,  nanoMY_pb_pb2.IS_8):   ('int8_t',  'SINT32',  2,  1),
    (FieldD.TYPE_SINT32, nanoMY_pb_pb2.IS_16):   ('int16_t', 'SINT32',  3,  2),
    (FieldD.TYPE_SINT32, nanoMY_pb_pb2.IS_32):   ('int32_t', 'SINT32',  5,  4),
    (FieldD.TYPE_SINT32, nanoMY_pb_pb2.IS_64):   ('int64_t', 'SINT32', 10,  8),
    (FieldD.TYPE_UINT32,  nanoMY_pb_pb2.IS_8):   ('uint8_t', 'UINT32',  2,  1),
    (FieldD.TYPE_UINT32, nanoMY_pb_pb2.IS_16):   ('uint16_t','UINT32',  3,  2),
    (FieldD.TYPE_UINT32, nanoMY_pb_pb2.IS_32):   ('uint32_t','UINT32',  5,  4),
    (FieldD.TYPE_UINT32, nanoMY_pb_pb2.IS_64):   ('uint64_t','UINT32', 10,  8),
    (FieldD.TYPE_INT64,   nanoMY_pb_pb2.IS_8):   ('int8_t',   'INT64', 10,  1),
    (FieldD.TYPE_INT64,  nanoMY_pb_pb2.IS_16):   ('int16_t',  'INT64', 10,  2),
    (FieldD.TYPE_INT64,  nanoMY_pb_pb2.IS_32):   ('int32_t',  'INT64', 10,  4),
    (FieldD.TYPE_INT64,  nanoMY_pb_pb2.IS_64):   ('int64_t',  'INT64', 10,  8),
    (FieldD.TYPE_SINT64,  nanoMY_pb_pb2.IS_8):   ('int8_t',  'SINT64',  2,  1),
    (FieldD.TYPE_SINT64, nanoMY_pb_pb2.IS_16):   ('int16_t', 'SINT64',  3,  2),
    (FieldD.TYPE_SINT64, nanoMY_pb_pb2.IS_32):   ('int32_t', 'SINT64',  5,  4),
    (FieldD.TYPE_SINT64, nanoMY_pb_pb2.IS_64):   ('int64_t', 'SINT64', 10,  8),
    (FieldD.TYPE_UINT64,  nanoMY_pb_pb2.IS_8):   ('uint8_t', 'UINT64',  2,  1),
    (FieldD.TYPE_UINT64, nanoMY_pb_pb2.IS_16):   ('uint16_t','UINT64',  3,  2),
    (FieldD.TYPE_UINT64, nanoMY_pb_pb2.IS_32):   ('uint32_t','UINT64',  5,  4),
    (FieldD.TYPE_UINT64, nanoMY_pb_pb2.IS_64):   ('uint64_t','UINT64', 10,  8),
}
...
class Field:
    ...
    def __init__(self, struct_name, desc, field_options):
        ...
        if field_options.type == nanoMY_pb_pb2.FT_INLINE:
            ...
            field_options.type = nanoMY_pb_pb2.FT_STATIC
        ...
        if field_options.type == nanoMY_pb_pb2.FT_DEFAULT:
            if can_be_static:
                field_options.type = nanoMY_pb_pb2.FT_STATIC
            else:
                field_options.type = nanoMY_pb_pb2.FT_CALLBACK

        if field_options.type == nanoMY_pb_pb2.FT_STATIC and not can_be_static:
        ...
        if field_options.type == nanoMY_pb_pb2.FT_STATIC:
            self.allocation = 'STATIC'
        elif field_options.type == nanoMY_pb_pb2.FT_POINTER:
            self.allocation = 'POINTER'
        elif field_options.type == nanoMY_pb_pb2.FT_CALLBACK:
        ...
        if desc.type in datatypes:
            ...
            if self.allocation == 'STATIC':
                ...
                # -1 because of null terminator. Both MY_pb_encode and MY_pb_decode
            ...
            if field_options.fixed_length:
                ...
                self.ctype = 'MY_pb_byte_t'
                self.array_decl += '[%d]' % self.max_size
            else:
                self.pbtype = 'BYTES'
                self.ctype = 'MY_pb_bytes_array_t'
                if self.allocation == 'STATIC':
        ...
        if self.allocation == 'POINTER':
            if self.rules == 'REPEATED':
                if self.pbtype == 'MSG_W_CB':
                    result += '    MY_pb_callback_t cb_' + self.name + ';\n'
                result += '    MY_pb_size_t ' + self.name + '_count;\n'
    ...
    def types(self):
        ...
        if self.pbtype == 'BYTES' and self.allocation == 'STATIC':
            result = 'typedef MY_PB_BYTES_ARRAY_T(%d) %s;\n' % (self.max_size, self.ctype)
        else:
            result = ''
        return result
    ...
    def requires_custom_field_callback(self):
        return self.allocation == 'CALLBACK' and self.callback_datatype != 'MY_pb_callback_t'

class ExtensionRange(Field):
    def __init__(self, struct_name, range_start, field_options):
        '''Implements a special MY_pb_extension_t* field in an extensible message
        ...
        self.fixed_count = False
        self.callback_datatype = 'MY_pb_extension_t*'

    def requires_custom_field_callback(self):
        return False

    def __str__(self):
        return '    MY_pb_extension_t *extensions;'
...
class ExtensionField(Field):
    ...
    def extension_decl(self):
        ...
        return ('extern const MY_pb_extension_type_t %s; /* field type: %s */\n' %
    ...
    def extension_def(self, dependencies):
        ...
        result += 'MY_pb_byte_t %s_default[] = {0x00};\n' % self.msg.name
        result += self.msg.fields_definition(dependencies)
        result += 'const MY_pb_extension_type_t %s = {\n' % self.fullname
        result += '    NULL,\n'
        result += '    NULL,\n'
        result += '    &%s_msg\n' % self.msg.name
        result += '};\n'
...
class OneOf(Field):
    ...
    def __str__(self):
        ...
        if self.fields:
            ...
            result += '    MY_pb_size_t which_' + self.name + ";\n"
            result += '    union {\n'
...
class Message(ProtoElement):
    ...
    def load_fields(self, desc, message_options):
        ...
        if hasattr(desc, 'oneof_decl'):
            for i, f in enumerate(desc.oneof_decl):
                oneof_options = get_nanoMY_pb_suboptions(desc, message_options, self.name + f.name)
                if oneof_options.no_unions:
                    no_unions.append(i) # No union, but add fields normally
                elif oneof_options.type == nanoMY_pb_pb2.FT_IGNORE:
        ...
        for f in desc.field:
            field_options = get_nanoMY_pb_suboptions(f, message_options, self.name + f.name)
            if field_options.type == nanoMY_pb_pb2.FT_IGNORE:
                continue
        ...
        if len(desc.extension_range) > 0:
            field_options = get_nanoMY_pb_suboptions(desc, message_options, self.name + 'extensions')
    ...
    def __str__(self):
        ...
        if self.packed:
            result = 'MY_PB_PACKED_STRUCT_START\n' + result
            result += '\nMY_PB_PACKED_STRUCT_END'
    ...
    def fields_declaration(self, dependencies):
        ...
        # Field descriptor array must be sorted by tag number, MY_pb_common.c relies on it.
        ...
        if has_callbacks:
            if self.callback_function != 'MY_pb_default_field_callback':
                result += "extern bool %s(MY_pb_istream_t *istream, MY_pb_ostream_t *ostream, const MY_pb_field_t *field);\n" % self.callback_function
        ...
        if defval:
            ...
            result += '#define %s_DEFAULT (const MY_pb_byte_t*)"%s\\x00"\n' % (self.name, hexcoded)
        else:
    ...
    def fields_declaration_cpp_lookup(self):
        ...
        result += '    static MY_PB_INLINE_CONSTEXPR const MY_pb_size_t fields_array_length = %d;\n' % (self.count_all_fields())
        result += '    static inline const MY_pb_msgdesc_t* fields() {\n'
        result += '        return &%s_msg;\n' % (self.name)
        result += '    }\n'
        result += '};'
        return result
...
class ProtoFile:
    ...
    def parse(self):
        ...
        flatten = mangle_names == nanoMY_pb_pb2.M_FLATTEN
        strip_prefix = None
        replacement_prefix = None
        if mangle_names == nanoMY_pb_pb2.M_STRIP_PACKAGE:
            strip_prefix = "." + self.fdesc.package
        elif mangle_names == nanoMY_pb_pb2.M_PACKAGE_INITIALS:
            strip_prefix = "." + self.fdesc.package
            replacement_prefix = ""
        ...
        def create_name(names):
            if mangle_names in (nanoMY_pb_pb2.M_NONE, nanoMY_pb_pb2.M_PACKAGE_INITIALS):
        ...
        def mangle_field_typename(typename):
            if mangle_names == nanoMY_pb_pb2.M_FLATTEN:
        ...
        for index, enum in enumerate(self.fdesc.enum_type):
            ...
            enum_options = get_nanoMY_pb_suboptions(enum, self.file_options, name)
        ...
        for index, (names, message) in enumerate(iterate_messages(self.fdesc, flatten)):
            ...
            message_options = get_nanoMY_pb_suboptions(message, self.file_options, name)
            ...
            for index, enum in enumerate(message.enum_type):
                ...
                enum_options = get_nanoMY_pb_suboptions(enum, message_options, name)
                self.enums.append(Enum(name, enum, enum_options, index, self.comment_locations))

        for names, extension in iterate_extensions(self.fdesc, flatten):
            name = create_name(names + extension.name)
            field_options = get_nanoMY_pb_suboptions(extension, self.file_options, name)
    ...
    def generate_header(self, includes, headername, options):
        ...
        if options.notimestamp:
            ...
            yield '/* Generated by %s at %s. */\n\n' % (nanoMY_pb_version, time.asctime())

        if self.fdesc.package:
            symbol = make_identifier(self.fdesc.package + '_' + headername)
        else:
            symbol = make_identifier(headername)
        yield '#ifndef MY_PB_%s_INCLUDED\n' % symbol
        yield '#define MY_PB_%s_INCLUDED\n' % symbol
        ...
        yield '#if MY_PB_PROTO_HEADER_VERSION != 40\n'
        ...
        if self.messages:
            ...
            for msg in self.messages:
                yield 'extern const MY_pb_msgdesc_t %s_msg;\n' % msg.name
            yield '\n'
    ...
    def generate_source(self, headername, options):
        ...
        if self.messages:
            ...
            if largest_count > 64:
                ...
                yield '#if MY_PB_MAX_REQUIRED_FIELDS < %d\n' % largest_count
                yield '#error Properly detecting missing required fields in %s requires \\\n' % largest_msg.name
                yield '       setting MY_PB_MAX_REQUIRED_FIELDS to %d or more.\n' % largest_count
                yield '#endif\n'
        ...
        if has_double:
            yield '\n'
            yield '#ifndef MY_PB_CONVERT_DOUBLE_FLOAT\n'
            yield '/* On some platforms (such as AVR), double is really float.\n'
            yield ' * To be able to encode/decode double on these platforms, you need.\n'
            yield ' * to define MY_PB_CONVERT_DOUBLE_FLOAT in pb.h or compiler command line.\n'
            yield ' */\n'
            yield 'MY_PB_STATIC_ASSERT(sizeof(double) == 8, DOUBLE_MUST_BE_8_BYTES)\n'
            yield '#endif\n'
...
def read_options_file(infile):
    ...
    for i, line in enumerate(data.split('\n')):
        ...
        opts = nanoMY_pb_pb2.NanoPBOptions()
...
def get_nanoMY_pb_suboptions(subdesc, options, name):
    '''Get copy of options, and merge information from subdesc.'''
    new_options = nanoMY_pb_pb2.NanoPBOptions()
    ...
    if isinstance(subdesc.options, descriptor.FieldOptions):
        ext_type = nanoMY_pb_pb2.nanopb
    elif isinstance(subdesc.options, descriptor.FileOptions):
        ext_type = nanoMY_pb_pb2.nanoMY_pb_fileopt
    elif isinstance(subdesc.options, descriptor.MessageOptions):
        ext_type = nanoMY_pb_pb2.nanoMY_pb_msgopt
    elif isinstance(subdesc.options, descriptor.EnumOptions):
        ext_type = nanoMY_pb_pb2.nanoMY_pb_enumopt
    else:
...
optparser = OptionParser(
    usage = "Usage: nanoMY_pb_generator.py [options] file.pb ...",
...
optparser.add_option("--cpp-descriptors", action="store_true",
    help="Generate C++ descriptors to lookup by type (e.g. MY_pb_field_t for a message)")
...
def parse_file(filename, fdesc, options):
    ...
    toplevel_options = nanoMY_pb_pb2.NanoPBOptions()
    ...
    # Parse the file
    file_options = get_nanoMY_pb_suboptions(fdesc, toplevel_options, Names([filename]))
...
def main_plugin():
    ...
    optparser.usage = "Usage: protoc --nanoMY_pb_out=[options][,more_options]:outdir file.proto"
