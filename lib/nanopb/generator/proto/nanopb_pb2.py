...
NANOMY_PB_FILEOPT_FIELD_NUMBER = 1010
nanoMY_pb_fileopt = _descriptor.FieldDescriptor(
  name='nanoMY_pb_fileopt', full_name='nanoMY_pb_fileopt', index=0,
  number=1010, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
NANOMY_PB_MSGOPT_FIELD_NUMBER = 1010
nanoMY_pb_msgopt = _descriptor.FieldDescriptor(
  name='nanoMY_pb_msgopt', full_name='nanoMY_pb_msgopt', index=1,
  number=1010, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
NANOMY_PB_ENUMOPT_FIELD_NUMBER = 1010
nanoMY_pb_enumopt = _descriptor.FieldDescriptor(
  name='nanoMY_pb_enumopt', full_name='nanoMY_pb_enumopt', index=2,
  number=1010, type=11, cpp_type=10, label=1,
  has_default_value=False, default_value=None,
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
NANOMY_PB_FIELD_NUMBER = 1010
...
_NANOPBOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=b"MY_pb_callback_t".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=b"MY_pb_default_field_callback".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
...
DESCRIPTOR.extensions_by_name['nanoMY_pb_fileopt'] = nanoMY_pb_fileopt
DESCRIPTOR.extensions_by_name['nanoMY_pb_msgopt'] = nanoMY_pb_msgopt
DESCRIPTOR.extensions_by_name['nanoMY_pb_enumopt'] = nanoMY_pb_enumopt
...
NanoPBOptions = _reflection.GeneratedProtocolMessageType('NanoPBOptions', (_message.Message,), {
  ...
  '__module__' : 'nanoMY_pb_pb2'
  # @@protoc_insertion_point(class_scope:NanoPBOptions)
  })
_sym_db.RegisterMessage(NanoPBOptions)

nanoMY_pb_fileopt.message_type = _NANOPBOPTIONS
google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(nanoMY_pb_fileopt)
nanoMY_pb_msgopt.message_type = _NANOPBOPTIONS
google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(nanoMY_pb_msgopt)
nanoMY_pb_enumopt.message_type = _NANOPBOPTIONS
google_dot_protobuf_dot_descriptor__pb2.EnumOptions.RegisterExtension(nanoMY_pb_enumopt)
