...
#ifndef MY_PB_FINAL_PAM_UPLOAD_PB_H_INCLUDED
#define MY_PB_FINAL_PAM_UPLOAD_PB_H_INCLUDED
#include <MY_pb.h>
...
typedef struct _SystemTopology { 
    MY_pb_callback_t devices; 
    MY_pb_callback_t diagnostics; 
    MY_pb_callback_t subSystems; 
} SystemTopology;

typedef struct _Calibration { 
    MY_pb_callback_t name; 
    float zero; 
...
typedef struct _DataPoint { 
    MY_pb_callback_t name; 
    MY_pb_callback_t value; 
    Units units; 
    MY_pb_callback_t SSID; 
} DataPoint;
...
#define SystemManifest_CALLBACK MY_pb_default_field_callback
...
#define SystemTopology_CALLBACK MY_pb_default_field_callback
...
#define SystemSettings_CALLBACK MY_pb_default_field_callback
...
#define Calibration_CALLBACK MY_pb_default_field_callback
...
#define SubSystem_CALLBACK MY_pb_default_field_callback
...
#define Device_CALLBACK MY_pb_default_field_callback
...
X(a, CALLBACK, SINGULAR, STRING,   SSID,              2) \
X(a, STATIC,   SINGULAR, UENUM,    units,             3)
#define Diagnostic_CALLBACK MY_pb_default_field_callback
...
#define Upload_CALLBACK MY_pb_default_field_callback
...
#define DataPoint_CALLBACK MY_pb_default_field_callback
